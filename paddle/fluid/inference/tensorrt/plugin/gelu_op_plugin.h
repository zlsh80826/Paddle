...
class GeluPlugin : public PluginTensorRT {
 public:
  ...
  ~GeluPlugin() {}
  GeluPlugin* clone() const TRT_NOEXCEPT override { return new GeluPlugin(with_fp16_); }

  const char* getPluginType() const TRT_NOEXCEPT override { return "gelu_plugin"; }
  ...
  int enqueue(int batch_size, void const *const *inputs, void *const *outputs,
...
class GeluPluginDynamic : public DynamicPluginTensorRT {
 public:
  ...
  bool supportsFormatCombination(int pos,
                                 ...
                                 int nb_inputs, int nb_outputs) TRT_NOEXCEPT override;
