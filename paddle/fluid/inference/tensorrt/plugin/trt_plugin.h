...
class PluginTensorRT : public nvinfer1::IPluginV2 {
 public:
  ...
  // Execute the layer
  virtual int enqueue(int batch_size, void const *const *inputs, void *const *outputs,
  ...
  bool supportsFormat(nvinfer1::DataType type,
                      nvinfer1::PluginFormat format) const TRT_NOEXCEPT override;
  // Configure the layer
  ...
  void setPluginNamespace(nvinfer1::AsciiChar const *plugin_namespace) TRT_NOEXCEPT override;

  nvinfer1::AsciiChar const* getPluginNamespace() const TRT_NOEXCEPT override;
 ...
 protected:
  ...
  nvinfer1::AsciiChar const* namespace_;
