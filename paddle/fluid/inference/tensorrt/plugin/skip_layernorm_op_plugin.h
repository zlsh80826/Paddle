...
class SkipLayerNormPluginDynamic : public DynamicPluginTensorRT {
 public:
  ...
  const char* getPluginType() const TRT_NOEXCEPT override { return "skip_layernorm_plugin"; }
...
class SkipLayerNormPluginV2Creator : public nvinfer1::IPluginCreator {
 public:
  ...
  const char* getPluginName() const TRT_NOEXCEPT override { return "skip_layernorm_plugin"; }
