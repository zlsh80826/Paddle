...
nvinfer1::IPluginV2DynamicExt* SpecialSlicePluginDynamic::clone() const TRT_NOEXCEPT {
...
const char* SpecialSlicePluginDynamicCreator::getPluginName() const TRT_NOEXCEPT {
  return "special_slice_plugin";
}

const char* SpecialSlicePluginDynamicCreator::getPluginVersion() const TRT_NOEXCEPT {
  return "1";
}
...
nvinfer1::IPluginV2* SpecialSlicePluginDynamicCreator::deserializePlugin(
    const char* name, const void* serial_data, size_t serial_length) TRT_NOEXCEPT {
...
const char* SpecialSlicePluginDynamicCreator::getPluginNamespace() const TRT_NOEXCEPT {
