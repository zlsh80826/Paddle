...
class QkvToContextPluginDynamic : public DynamicPluginTensorRT {
 public:
  ...
  const char* getPluginType() const TRT_NOEXCEPT override { return "qkv_to_context_plugin"; }
...
class QkvToContextPluginV2Creator : public nvinfer1::IPluginCreator {
 public:
  ...
  const char* getPluginName() const TRT_NOEXCEPT override { return "qkv_to_context_plugin"; }
