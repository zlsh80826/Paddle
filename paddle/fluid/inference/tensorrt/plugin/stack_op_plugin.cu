...
const char* StackPluginDynamic::getPluginType() const TRT_NOEXCEPT { return "stack_plugin"; }
...
const char* StackPluginDynamicCreator::getPluginVersion() const TRT_NOEXCEPT { return "1"; }
...
void StackPluginDynamicCreator::setPluginNamespace(const char* lib_namespace) TRT_NOEXCEPT {
